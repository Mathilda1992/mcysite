...
urlpatterns = [
    ...
    url(r'^exp_remove_VM/(\d+)$', exp_remove_VM, name='exp_remove_VM'),
    url(r'^exp_set_default_operateVM/(\d+)$', exp_set_default_operateVM, name='exp_set_default_operateVM'),
    url(r'^exp_set_operateVM/(\d+)$', exp_set_operateVM, name='exp_set_operateVM'),
    url(r'^exp_unset_operateVM/(\d+)$', exp_unset_operateVM, name='exp_unset_operateVM'),
    ...
    url(r'^exp_result_launch/(\d+)/$', exp_result_launch, name='exp_result_launch'),
